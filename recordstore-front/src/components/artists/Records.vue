<template>
  <div class="max-w-md m-auto py-10">
    ...
    <form action="" @submit.prevent="addRecord">
      ...
      <input type="submit" value="Add Record" class="font-sans font-bold px-4 rounded cursor-pointer no-underline bg-black hover:bg-gray-700 block w-full py-4 text-white items-center justify-center" />
    </form>
