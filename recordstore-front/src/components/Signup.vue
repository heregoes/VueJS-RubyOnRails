  ...
  <div class="max-w-sm m-auto my-8">
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signup">
        ...
        <button type="submit" class="font-sans font-bold px-4 rounded cursor-pointer no-underline bg-black hover:bg-gray-700 block w-full py-4 text-white items-center justify-center">Sign Up</button>
